          ...
          <h1><canvas id="textCanvas" width="300" height="160" margin-bottom:"100px" hidden
            ...
            <section>
                ...
                <section>
                    <h3>1.2 游戏界面</h3>
                    <p>
                        作战星图——在星图中可以看到自己的位置（黑点），探测范围和方向（扇形区域），以及自己的目标位置（+）。在星图上点击可以改变目标位置。
                     ...
                     <p>
                        ...
                        操作面板——通过操作面板可以采集资源，建造飞船，升级技能，升级探测范围，升级移动速度，升级攻击范围等。
                        资源会每秒生产，每1000资源会升一级。每升一级可以多出一个操作仓。
                        每个操作仓每秒钟会生产各种设备。
                        通过调节操作仓的数量，来调节生产各种设备的速度。
                    </p>
                     <p> 
                         宇宙广播——通过宇宙广播可以看到当前游戏中的所有玩家，并可以在公共频道聊天，或者私聊。
                           <p> 
                        点击原网页开始游戏
                    </p>
